...
::tab1	wb	IconTab+6,(39-TrashX)
	...
	ww	Anzeige_Men}+2+3,48
	ww	Anzeige_Men}+4+3,161
	ww	Disk_Men}+2+3,79
	ww	Disk_Men}+4+3,161
	ww	WindowMen}+2+3,103
	ww	WindowMen}+4+3,222
	ww	Speziell_Men}+2+15,145
	ww	Speziell_Men}+4+15,238
	w	0
::tab2	wb	IconTab+6,(39-TrashX)*2
	...
	ww	geosoben+4,104
	ww	Datei_Men}+2+3,37
	ww	Datei_Men}+4+3,149
	ww	Anzeige_Men}+2+3,63
	ww	Anzeige_Men}+4+3,214
	ww	Disk_Men}+2+3,103
	ww	Disk_Men}+4+3,213
	ww	WindowMen}+2+3,134
	ww	WindowMen}+4+3,293
	ww	Speziell_Men}+2+15,189
	ww	Speziell_Men}+4+15,314
	w	0
...
.SchmalFlag	b	"  smal display",GOTOX
	w	180-22
...
::t3	b	"Data",0
::t4	b	"System file",0
::t5	b	"Desk accessory",0
::t6	b	"Application",0
::t7	b	"Document",0
::t8	b	"Font file",0
::t9	b	"Printer driver",0
::ta	b	"Input driver (64)",0
::tb	b	"Directory",0
::tc	b	"Boot file",0
::td	b	"temporary",0
::te	b	"auto exec",0
::tf	b	"Input driver (128)",0
...
:NoMultiFileBox	b	$81
	...
	b	OK,17,72
	b	NULL
::t1	b	BOLDON,"This function can not",0
::t2	b	"be carried out under",0
::t3	b	"Multi-File",0
