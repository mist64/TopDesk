...
::40	lda	#2
	...
	jsr	i_PutString
	w	79
	b	19,BOLDON,"Drive D",GOTOXY,46,0,32,"no drive"
...
::db	b	$81
	...
	w	:t3
	b	OK,17,72,NULL
::t1	b	"Drive D can not be installed",0
::t2	b	"as already reserved for RAM-",0
::t3	b	"or shadowed disk.",0
:MyInfo	w	0
...
::db	b	$81
	...
	w	:t4
	b	OK,17,72,NULL
::t1	b	"To install drive D",0
::t2	b	"drivs A-C must have first been",0
::t3	b	"installed with the CONFIGURE",0
::t4	b	"programme.",0
...
::db	b	$81
	...
	w	:t3
	b	OK,17,72,NULL
::t1	b	"To enable the installation of Drive D",0
::t2	b	"to be implemented at least one RAM-Disk",0
::t3	b	"must be present amongst drives A-C.",0
...
::db	b	$81
	...
	w	:t2
	b	OK,17,72,NULL
::t1	b	BOLDON,"The CONFIGURE programme cannot",0
::t2	b	"be found !",PLAINTEXT,0
::db2	b	$81
	b	$0b,$10,$10
	w	:t3
	b	$0b,$10,$20
	w	:t4
	b	OK,17,72,NULL
::t3	b	"Error whilst reading the ",0
::t4	b	"DiskDrivers",0
