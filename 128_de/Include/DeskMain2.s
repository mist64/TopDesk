...
::loop1	lda	windowTop,y
	...
	jsr	i_Rectangle
	b	2,12
	w	222+DOUBLE_W,236+DOUBLE_W
	MoveB	MultiCount,r0L
	LoadB	r0H,0
	LoadW	r11,223+DOUBLE_W
	LoadB	r1H,9
	lda	#%11000000
	jsr	PutDecimal
	ldy	#0
...
::20	jsr	PutString
	PopB	dispBufferOn
	rts
::t1	b	PLAINTEXT," wird kopiert",0
::t2	b	PLAINTEXT," wird gel|scht",0
...
::db	b	$81
	...
	b	OK,17,72,NULL
::t1	b	"Die Datei ",0
::t2	b	"ist schreibgesch}tzt",0
::t3	b	"und kann nicht gel|scht",0
::t4	b	"werden.",0
...
::db	b	$81
	...
	w	:t4
	b	NULL
::t1	b	BOLDON,"Achtung!",PLAINTEXT,0
::t2	b	"Operation abgebrochen aufgrund",0
::t3	b	"des Diskettenfehlers $"
::nr	b	"..",0
::t4	b	"auf Laufwerk "
::dr	b	".",0
::db2	b	$81
	...
	w	:t2b
	b	OK,17,72,0
::t1b	b	BOLDON,"Fehler!",0
::t2b	b	"Doppelseitige Disk in 1541.",0

::errtab	b	$21,FILE_EXISTS,3,10
::tab	w	:et1,:et2,:et3,:et4
::et1	b	"keine formatierte Diskette",0
::et2	b	"Name bereits vergeben",0
::et3	b	"Diskette voll",0
::et4	b	"unpassende Dateistruktur",0
::notext	b	0

:GenTab	b	0,0,0,0
:GenData	w	GenTab,DARecSpace     ; $7f80
:MySubMenuDA	LoadW	GenData+2,DARecSpace
	bne	MySub2
:MySubMenu	LoadW	GenData+2,DARecSpace  ; $7f80
:MySub2	LoadB	MyCurRec,0
	pla
	clc
	adc	#1
	sta	:r0
...
:ldar5yM	tya
	...
	DecW	r5
	;lda	(r5),y
	tya		; Zieladr (r5+y) in Reg $12/$13 setzen
	clc
	adc	r5L
	php
	ldx	#$13
...
:star5yM	sta	:b
	...
	ldx	#$1f
	lda	:b
	jsr	SetReg	; Inhalt aus $1f holen 
	ldx	#$12
	jsr	GetReg
	pla
	tax
