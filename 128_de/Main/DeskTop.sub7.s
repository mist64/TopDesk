...
::PrntDial
	...
	b	CANCEL,16,76
	b	NULL
::PrntZeile1	b	BOLDON,"Neuen ",0
::PrntZeile1_1	b	"Druckertreiber",0
::PrntZeile1_2	b	"Eingabetreiber",0
::PrntZeile2	b	"installieren?",0
:DA1	MoveW	r15,r6
	lda	#$00
	sta	r0L
	sta	r10L
...
::neudb	b	$81
	...
	w	:t3
	b	OK,14,72,NULL
::t1	b	BOLDON,"Bitte neu starten. Gleiche",0
::t2	b	"Systemdiskette verwenden wie",0
::t3	b	"bei Installation von TopDesk.",0
...
::abhier	b	$12,2,72
	...
	w	:icon4
	b	NULL
::t1	b	"Diskette zum Formatieren",0
::t2	b	"in Laufwerk "
::dr	b	". einlegen ",0
::t3	b	"und Name eingeben:",0
...
::db2	b	$81
	...
	b	NO,9,72
	b	NULL
::2t1	b	BOLDON,"Soll die Diskette",0
::2t2	b	"doppelseitig formatiert ",0
::2t3	b	"werden?",PLAINTEXT,0
:IconA
...
::rentext	b	BOLDON,"Bitte geben Sie den neuen",0
::rentxt2	b	"Diskettennamen ein:",PLAINTEXT,0
