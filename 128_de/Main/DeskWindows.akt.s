...
::t1	b	"Bitte eine Diskette mit",0
::t2	b	"TopDesk einlegen!",0
...
.iconTab	w	0
.NameIndex	s	4
.RightMax	w	639	; 40z: 319	80z: 639
.GraphIndex	b	1	; 40z: 8	80z: 1
...
::10	lda	r2,y
	...
	MoveW	RightMax,mouseRight  ; 319 oder 639
...
::03	PushW	r13
	...
	rts
::sub	jsr	DispTest
	jsr	GetScanLine	; Zeilenadresse holen	
	lda	r5H
	bmi	:s10
	MoveB	r10H,r6H			; 80: Index = xk DIV 8
	lda	r10L	; d.h. y = xk DIV 8
	lsr	r6H
	ror
	lsr	r6H
	ror
	...
	tay
	jmp	:s11
::s10	lda	r10H	; 40: Index = int(xk/8*8) = xk AND $f8
	clc		; d.h. r5H=r5H+r10H
	adc	r5H	; und y = r10 AND $f8
	sta	r5H
	lda	r10L
	and	#%11111000
	sta	r11L
	tay
::s11	lda	r10L	; x = r10 AND 7
	and	#%111
	sta	r11H
	tax
	lda	r5H	; 80-Zeichen ?
	...
	jsr	ldar5y
	jmp	:64b
::64a	lda	(r5),y	; zu }berschreibende Bits am linken Rand
::64b	and	BitMaske2,x	; ausmaskieren
	pha
...
::50	sty	r11L
	...
	jmp	:64d
::64c	lda	(r5),y
::64d	and	BitMaske1,x	; Bits am rechten Rand ausmaskieren
	pha
...
.star5y	;sta	(r5),y
	...
	ldx	#$1f	; sta (last)
	jsr	SetReg
	ldx	#$12	; Zeichen schreiben durch beliebiges
	jmp	SetReg	; Beschreiben von Reg. $12
